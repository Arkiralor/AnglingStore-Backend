...
from middleware_app.serializers import RequestLogInputSerializer
...
class RequestLogger(object):
    ...
    def record_in_nosql(self, method:str=None, path:str=None, cookies:str=None, body:bytes=None, headers:dict=None, params:dict=None, user:User=None, *args, **kwargs):
        """
        ...
        try:
            no_sql_data = {
                ...
                "timestampUtc": datetime.now(tz=timezone.utc)
            }
    ...
    @enqueue_job_decorator
    def record_in_sql(self, method:str=None, path:str=None, cookies:str=None, body:bytes=None, headers:dict=None, params:dict=None, user:User=None, *args, **kwargs):
        """
        ...
        try:
            ...
            deserialized = RequestLogInputSerializer(data=data)
            if not deserialized.is_valid():
                logger.warning(f"{deserialized.errors}")
